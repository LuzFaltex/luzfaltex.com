...
* permits or enables unauthorized access to the Communities or information of other users, except as defined in the [LuzFaltex Security Vulnerability Reporting Policy](xref:vulnerability-reporting-policy);
